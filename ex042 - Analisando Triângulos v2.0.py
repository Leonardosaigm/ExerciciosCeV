...
if ((numero1+numero2)>numero3) and ((numero1+numero3)>numero2) and ((numero2+numero3)>numero1) and (numero1 == numero2 == numero3):
    print('É possível realizar um triângulo com os números que você apresentou e ele será do tipo Equilátero!')
elif ((numero1+numero2)>numero3) and ((numero1+numero3)>numero2) and ((numero2+numero3)>numero1) and ((numero2 == numero1 or numero2 == numero3) or (numero1 == numero3)):
    print('É possível realizar um triângulo com os números que você apresentou e ele será do tipo Isósceles!')
elif ((numero1+numero2)>numero3) and ((numero1+numero3)>numero2) and ((numero2+numero3)>numero1) and (numero1 != numero2 != numero3):
